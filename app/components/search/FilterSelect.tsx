    ...
    <div className="flex flex-col gap-1 p-1">
      <SelectProvider value={selectedGenres} setValue={onChange}>
        ...
        <SelectPopover
          ...
          sameWidth
          unmountOnHide
          className="popover bg-background w-[300px] z-50 max-h-[min(var(--popover-available-height, 300px), 300px)] flex flex-col gap-2 justify-center items-center overscroll-contain rounded-lg border border-solid p-2 overflow-auto text-[white] [box-shadow:0_10px_15px_-3px_rgb(0_0_0_/_0.25),_0_4px_6px_-4px_rgb(0_0_0_/_0.1)]"
        >
          <LogicToggle />
