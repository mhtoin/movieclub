...
export function MobileRaffleButton() {
  ...
  return (
    <div className="flex flex-col justify-center">
      <button
        className={`text-md p-0 m-0 transform active:scale-75 transition-transform ${effect && "animate-button-press"}`}
        onClick={() => {
          //console.log("clicked");
          setIsLoading(true);
          setIsOpen(true);
      ...
      >
        ...
        <span className="btm-nav-label">Raffle</span>
      </button>
    </div>
  );
}
