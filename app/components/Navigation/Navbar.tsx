...
export const NavBar = ({
  ...
  if (isMobile) {
    return (
      <div className="min-w-screen flex items-center justify-center border-b p-2 z-50  bg-background min-h-[70px] h-[70px] ">
  ...
  return (
    <div className="min-w-screen flex items-center justify-center border-b p-2 z-50 bg-background h-[70px] min-h-[70px]">
