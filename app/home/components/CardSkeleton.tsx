export const CardSkeleton = () => {
  return (
    <div className="card md:card-side w-11/12 lg:w-[780px] lg:h-[740px] p-5 ">
      <div className="w-full h-[300px] sm:h-full sm:w-1/2 bg-gray-300 rounded-md "></div>
      <div className="card-body sm:w-1/2 p-5">
        <h2 className="card-title text-2xl text-left">
          <div className="h-2 w-1/3 bg-gray-300 rounded-md"></div>
        </h2>
        ...
        <h3 className="text-sm italic">
          <div className="h-1 w-12 bg-gray-300 rounded-md"></div>
        </h3>
        <svg
