...
export default function Tier({
	...
	return (
		...
		>
			...
			<button
				type="button"
				className={`hidden md:flex z-[9990] items-center justify-center absolute top-0 right-0 w-20 h-full bg-gradient-to-b from-transparent to-background group-hover:opacity-100 opacity-0 transition-all duration-300 hover:bg-accent/10 ${
